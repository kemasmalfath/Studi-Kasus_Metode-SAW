...
Script Python ini digunakan untuk menghitung dan menentukan peringkat berdasarkan metode **SAW (Simple Additive Weighting)**. W adalah salah satu metode ngambilan keputusmultikriteria (MCDM) yang umum dinan untuk menilai beberapa alternatif beasarkan sejumla\\\h k
## ✅ Tu
Menilai dan 
