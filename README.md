bgghuhuiiiiiuuuuuuhhhlllllll# 📊 Perhitungan SAW (Simple Additive Weightin

Script Python ini digunakan untuk menghitung dan menentukan peringkat berdarkan metode **SAW (Simple Additive Weighting)**. W adalah salah satu metode ngambilan keputusmultikrit (MCD) yang umum nan untu
| Kr
| C
| Asset    |
   ...
   - **Age**: 
2. **Hitung Nilai V (sk
   V = (w_cash × norm_cash) + (w
bblnjjnhhhljsisinjjjju
3. **Peringkat Alternatnjjjnnjkdkd
   - Diurutkan berdasarkan nilai `V` daikis yang tertinggi ke terend
