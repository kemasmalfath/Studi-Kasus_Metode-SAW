...
Script Python ini digumenghitung dan menentukan peringkat berdarkan metode **SAW (Simple Additive Weighting)**. W adalah salatu metode ngambilan keputusmultikr (M) yallm nan
|bdj
| As
   - **Cacxxx
2. llll
